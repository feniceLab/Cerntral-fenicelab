...
referencias: ["00-Central/Manual da Marca - Fenice Lab.md"]
status: oficial
tags: [fenice, planos, escopo, oferta, precificacao, proposta-comercial]
---

# 🔥 Escopo & Planos da Fênix — Fenice Lab

> A oferta oficial da Fenice Lab. Define **o que entregamos**, **em qual plano** e **por quê** — ancorado no valor, não na tarefa.
> **Promessa central:** *"Sua marca, presença diária no Instagram — com posicionamento, conteúdo que vende e tráfego que traz resultado."*
> **Filosofia da oferta:** a cada real a mais investido, a sensação de ganho aumenta. Foco de venda: **Combustão pra cima**; a Faísca é o mínimo valorizado (nunca básico demais).
...
### 🔥 FAÍSCA — R$ 1.500/mês
**"Sua marca se posiciona e aparece todo dia."**
Para o negócio que precisa existir com identidade de verdade e presença diária — o mínimo bem-feito para se posicionar.
...
Para quem vende produtos no digital e quer o pacote completo: e-commerce + assessoria estratégica personalizada + máxima presença.

---

## Matriz de Escopo

| Entrega | 🔥 FAÍSCA · R$1.500 | 🔥🔥 COMBUSTÃO · R$2.000 | 🔥🔥🔥 RENASCIMENTO · R$3.000 |
|---|:---:|:---:|:---:|
| **Tráfego pago (gestão)** | ✅ | ✅ | ✅ |
| **Identidade + manual de marca** | essencial | ✅ completo | ✅ completo |
| **Google Meu Negócio** | ✅ | ✅ | ✅ |
| **Landing page da marca** | — | ✅ | ✅ |
| **Reels (por semana)** | 1 | 2 | 3 |
| **Carrosséis (por semana)** | 1 | 1 | 2 |
| **Stories (por dia)** | 2 | 2 | 3 (renovados/mês) |
| **Stop motions** | — | ✅ | ✅+ |
| **Ações sazonais** | ✅ | ✅ | ✅ |
| **E-commerce** | — | — | ✅ |
...
## O que cada entrega significa (ancorado em valor)

- **Tráfego pago (gestão):** criamos e gerenciamos as campanhas no Meta/Google — é o que transforma presença em resultado (mais gente na porta / no perfil / na loja). *A verba do anúncio é paga pelo cliente, à parte (ver abaixo).*
- **Identidade + manual de marca:** sua marca deixa de parecer amadora. No Faísca é o essencial para posicionar; em Combustão/Renascimento é o manual completo.
- **Google Meu Negócio:** quando procurarem seu negócio no Google/Maps, ele aparece profissional e atualizado.
- **Landing page da marca:** página de conversão para o tráfego cair — transforma clique em contato/venda.
...
## Verba de Mídia (tráfego pago)

- O **cliente paga a verba de anúncios diretamente para a Meta** — à parte da mensalidade. A Fenice **gerencia** as campanhas.
- **Recomendação inicial:** R$20–30/dia (~R$600–900/mês). Ajustável conforme objetivo e plano.
- Transparência: o cliente vê o ROAS no portal (semanal e mensal).
...
## Garantia Fenice (processo, não milagre)

Garantimos o que controlamos 100%: **seus criativos no prazo e no padrão combinado.** Se falharmos nisso, o mês seguinte é por nossa conta. Não prometemos número mágico — prometemos dedicação, processo e transparência.

---

## Add-ons (sobre qualquer plano)

- **TikTok:** +R$500/mês (adapta/reaproveita os criativos do Instagram).

---

## Regras de apresentação (proposta comercial)
