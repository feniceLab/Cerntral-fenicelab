// ============================================================
// Icone local do modulo Trafego Pago.
// O Icon do @fenice/shared cobre so um subconjunto; aqui ficam
// os paths Lucide-like que o prototipo usa (target, megaphone...).
// ============================================================
import type { CSSProperties } from 'react';

export const TP_PATHS = {
  target:
    'M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18ZM12 16a4 4 0 1 0 0-8 4 4 0 0 0 0 8ZM12 13a1 1 0 1 0 0-2 1 1 0 0 0 0 2Z',
  megaphone:
    'M3 11v2a1 1 0 0 0 1 1h2l3.5 4V6L6 10H4a1 1 0 0 0-1 1ZM14 7s3 1.5 3 5-3 5-3 5M18 4s4 2 4 8-4 8-4 8',
  grid: 'M4 4h7v7H4zM13 4h7v7h-7zM13 13h7v7h-7zM4 13h7v7H4z',
  layers: 'M12 3 2 8l10 5 10-5-10-5ZM2 13l10 5 10-5M2 18l10 5 10-5',
  rocket:
    'M5 13l-2 6 6-2M9 15l-3-3a13 13 0 0 1 9-9c2.5 0 4 1.5 4 4a13 13 0 0 1-9 9l-1-1ZM14 9a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z',
  play: 'M7 4v16l13-8z',
  ...
  pin: 'M12 2a7 7 0 0 1 7 7c0 5-7 13-7 13S5 14 5 9a7 7 0 0 1 7-7ZM12 11.5a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5Z',
...
export type TpIconName = keyof typeof TP_PATHS;

export interface TpIconProps {
  name: TpIconName;
  size?: number;
  color?: string;
  sw?: number;
